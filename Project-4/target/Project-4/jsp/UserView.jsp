 ...
 <form action="<%=ORSView.USER_CTL%>" method="post">
   ...
   <center>
    ...
    <div align="center">    
            ...
            <input type="hidden" name="modifiedBy" value="<%=bean.getModifiedBy()%>"> s
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="firstName" placeholder="Enter First Name" size="23"  value="<%=DataUtility.getStringData(bean.getFirstName())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="lastName" placeholder="Enter Last Name" size="23" value="<%=DataUtility.getStringData(bean.getLastName())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter Vallid Email-Id" size="23" value="<%=DataUtility.getStringData(bean.getLogin())%>"
                        <%=(bean.getID() > 0) ? "readonly" : ""%>> 
                        </td><td style="position: fixed"><font  color="red"> <%=ServletUtility.getErrorMessage("login", request)%></font></td>
                </tr>
                ...
                <%}else{ %>    <tr><th style="padding: 3px"></th></tr>          

                <tr>
                    <th align="left">Password <span style="color: red">*</span></th>
                    <td><input type="password" name="password" placeholder="Shubham@123" size="23"value="<%=DataUtility.getStringData(bean.getPassword())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirmPassword" placeholder="Re-Enter Password" size="23" value="<%=DataUtility.getStringData(bean.getPassword())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                  ...
                  <tr> 
                   	<th align="left">Role <span style="color: red">*</span></th>                  	 <td> 
                     <%=HTMLUtility.getList("roleId", String.valueOf(bean.getRoleID()), list) %>
                   </td><td style="position: fixed"><font color="red"> 
                 <%=ServletUtility.getErrorMessage("roleId", request)%></font></td>
                 </tr> 
...
<tr><th style="padding: 3px"></th></tr> 
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" id="datepicker" placeholder="Greater then 18 year"  size= "23" readonly="readonly"  value="<%=DataUtility.getDateString(bean.getDob())%>">
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="mobileno" maxlength="10" placeholder="Enter Mobile No" size= "23" value="<%=DataUtility.getStringData(bean.getMobileNo())%>">
                    </td><td style="position: fixed"><font color="red"> <%=ServletUtility.getErrorMessage("mobileno", request)%></font></td>
                </tr>
    <tr><th style="padding: 3px"></th></tr>          
