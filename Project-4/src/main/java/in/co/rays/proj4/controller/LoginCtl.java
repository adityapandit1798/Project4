...
public class LoginCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("populate bean-->" + ub);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(" Method doGet Started");
		...
		System.out.println("UserCtl Method doPost Ended");
...
//if option sign in
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			...
			String loginid=ub.getLogin();
			String password = ub.getPassword();
			System.out.println("login-->" +loginid +"\t  passsword-->" +password);
			try {
					System.out.println("inside try");
				ub = um.authenticate(loginid, password);
				System.out.println("authicentication done");
				if (ub != null) {
